...
const char *ModuleManager::mspName = "ColorSpace";
const char *ModuleManager::mspVersion = "0.1";
const char *ModuleManager::mspDescription = "Tools for working with various colorspaces.";
const char *ModuleManager::mspValidationKey = "none";
const char *ModuleManager::mspUniqueId = "{2042F53C-9073-43AA-A514-D20197359F25}";
