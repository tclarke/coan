...
const char *ModuleManager::mspName = "Las";
const char *ModuleManager::mspVersion = "1.0a";
const char *ModuleManager::mspDescription = "LAS LIDAR data importer.";
const char *ModuleManager::mspValidationKey = "none";
const char *ModuleManager::mspUniqueId = "{2C2BA439-DAD6-43ED-BAD4-ED0A52835EE5}";
