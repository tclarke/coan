...
const char *ModuleManager::mspName = "Timeline";
const char *ModuleManager::mspVersion = "";
const char *ModuleManager::mspDescription = "Timeline widget";
const char *ModuleManager::mspValidationKey = "none";
const char *ModuleManager::mspUniqueId = "{2AB79C19-C3C5-423A-88B7-101AEADDB1BA}";
